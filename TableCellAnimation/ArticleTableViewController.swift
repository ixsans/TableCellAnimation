...
//        UIView.animate(withDuration: 1.0, animations: {cell.alpha = 1})
        ...
        //ROTATION
//        let rotationAngleRadians = 90.0 * CGFloat(M_PI/180.0)
//        let rotatitonTransform = CATransform3DMakeRotation(rotationAngleRadians, 0, 0, 1)
//        cell.layer.transform = rotatitonTransform
//        UIView.animate(withDuration: 1.0, animations: { cell.layer.transform = CATransform3DIdentity})
        
        // TRANSLATION
        let rotatitonTransform = CATransform3DTranslate(CATransform3DIdentity, -500, 100, 0)
        cell.layer.transform = rotatitonTransform
        UIView.animate(withDuration: 1.0, animations: { cell.layer.transform = CATransform3DIdentity})
